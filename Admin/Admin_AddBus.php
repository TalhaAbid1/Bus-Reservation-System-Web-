      ...
      elseif (isset($_GET['done'])) 
      {
         $msg = $_GET['done'];    
          if ($msg='success') 
          {
             ...
             <h5>Successfull Added New Bus</h5>
            </div>";
          } 
       }
       ?>

      <h1>Add New Bus <i class="fa fa-bus" aria-hidden="true"></i></h1>
      <div class="form-group">
    <form method="POST" action="ValidAddBusForm.php">
      
      
      <label>Number:</label>
      <input type="Number" class="form-control" name="bn" placeholder="Bus Number*"  value=<?php 
       if (isset($_GET['bn1'])) {
          echo $_GET['bn1'];
       }          
       ?> ><br>
      ...
      <button class="btn btn-primary w-100" name="submit" >ADD</button>
      </div>
      </form>
